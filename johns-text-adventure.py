...
if item == "Fishsticks" or item == "fishsticks" or item == "FISHSTICKS":
    time.sleep(3)
    ...
    if item == "Badger slippers" or item == "Badger Slippers" or item == "badger slippers":
        ...
        if item == "Tame beaver" or item == "Tame Beaver" or item == "tame beaver":
